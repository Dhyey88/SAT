...
class WebViewController: UIViewController, WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler {
    ...
    (function() {
        var css = [
            ...
            '/* 1. Standard Modals (View Voucher, Remarks, View Document, Bills, Payables) */',
            'html body div#myVoucherType.modal:not(.ags-modal-responsive),',
            'html body #myVoucherType:not(.ags-modal-responsive),',
            'html body div#myVoucherType:not(.ags-modal-responsive),',
            'div#myVoucherType.modal:not(.ags-modal-responsive),',
            '#myVoucherType.modal:not(.ags-modal-responsive),',
            'body #myVoucherType:not(.ags-modal-responsive),',
            ...
            'html body div.modal.ags-modal-responsive,',
            'html body div.ags-modal-responsive,',
            'html body .ags-modal-responsive,',
